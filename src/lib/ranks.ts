...
const RANK_DEFINITIONS: { key: string; name: string; color: string; textColor: string; bgColor: string; borderColor: string; emoji: string; thresholds: [number, number, number] }[] = [
  ...
  { key: 'silver', name: 'ranks.silver', color: 'from-zinc-400 to-zinc-300', textColor: 'text-gray-500 font-extrabold drop-shadow-[0_0_12px_rgba(120,120,140,0.9)]', bgColor: 'bg-gray-500/20', borderColor: 'border-gray-400/50', emoji: '🥈', thresholds: [9, 12, 15] },
